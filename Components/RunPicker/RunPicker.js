      ...
      <Container style={styles.container}>
        <Content>
          ...
          <Form>
            ...
            <Picker.Item label="=== COMMON RUNS ===" value="1001 IGNORE" color="#12c2e9" />
            ...
            <Picker.Item label="= COMMON EXTRAS 1 & 2 RUNS =" value="1001 IGNORE" color="#12c2e9" />
            ...
            <Picker.Item label="+2 LEG-BYES" value="2 LEG-BYE"  />
                ...
                <Picker.Item label="+4 NO-BALLS" value="4 NO-BALL" />
                ...
                <Picker.Item label="+5 NO-BALLS" value="5 NO-BALL" />
                ...
                <Picker.Item label="+1 NO-BALLS AND 1 RUN" value="2 NO-BALLS" />
                ...
                <Picker.Item label="+1 NO-BALLS AND 2 RUNS" value="3 NO-BALLS" />
                ...
                <Picker.Item label="+1 NO-BALLS AND 3 RUNS" value="4 NO-BALLS" />
...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
      ...
      borderRadius: 50,
      height: PixelRatio.get() === 2 && Platform.OS === 'ios' && (width < 375) ? 120 : PixelRatio.get() === 2 && Platform.OS === 'ios' && (width >= 375) ? 140 : 50,
      width: PixelRatio.get() === 2 && Platform.OS === 'ios' && (height <= 568) ? 85 : PixelRatio.get() === 2 && Platform.OS === 'ios' && (width < 375) ? 90 : PixelRatio.get() === 2 && Platform.OS === 'ios' && (width >= 375) ? 85 : PixelRatio.get() === 3 && (width >= 414 && height < 896) ? 100 : PixelRatio.get() === 3 && (height >= 896) ? 105 : PixelRatio.get() === 3 && (width < 414 && width >= 375) ? 110 : 90,
  },
  rowPadding: {
    ...
    PixelRatio.get() === 2 && Platform.OS === 'ios' && (height <= 568) ? 0 :
     PixelRatio.get() === 2 && Platform.OS === 'ios' && (width < 375) ? 45 :
      PixelRatio.get() === 2 && Platform.OS === 'ios' && (width >= 375) ? 30 :
  ...
  textStyle: {
    ...
    justifyContent: 'center',
    marginTop: PixelRatio.get() === 2 ? '40%' : '25%',
},
plaeholder: {
  fontSize: PixelRatio.get() === 2 && Platform.OS === 'ios' && (height <= 568) ? 90 : PixelRatio.get() === 2 && Platform.OS === 'ios' && (width < 375) ? 105 : PixelRatio.get() === 2 && Platform.OS === 'ios' && (width >= 375) ? 91 : PixelRatio.get() === 3 && (width >= 414 && height < 896) ? 125 : PixelRatio.get() === 3 && (height >= 896) ? 140 : PixelRatio.get() === 3 && (width < 414 && width >= 375) ? 140 : 100,
  color: '#c471ed',
  justifyContent: 'center',
